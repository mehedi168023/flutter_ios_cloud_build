...
class TopPlayersScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const board = MockData.leaderboard;
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      const Text('Your Position', style: AppTextStyles.body2),
                ...
                Column(
                  ...
                  children: [
                    const Text('Total Earnings', style: AppTextStyles.body2),
                    Text(taka(0),
                        style:
